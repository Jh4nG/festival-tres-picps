export const InscripcionesJSON = {
    ...
    inscripciones: [
        {
            id: 1,
            title: "Cierra el 15 de junio",
            img: "./assets/img/inscripciones/inscripcion2.jpeg",
            path: "https://forms.gle/f2VKbmkrCZpcByEY7",
        },
        {
            id: 2,
            title: "Cierra el 8 de junio",
            img: "./assets/img/inscripciones/inscripcion1.jpeg",
            path: "https://forms.gle/vjgjzinZPqDajGmbA",
        },
    ],
    jurado: [
        {
