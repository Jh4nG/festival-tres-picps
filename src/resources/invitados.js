export const InvitadosJSON = {
    title: "Nuestros invitados",
    description:
        "Este año tenemos invitados locales y distritales que trabajan en lo comunitario y en el cine barrial y de bajo costo.",
    invitados: [
        {
            id: 1,
            title: "Leonardo Lovera (Invitado Local)",
            charge: "Invitado local",
            description:
                "Realizador audiovisual, documentalista y fotógrafo bogotano. Ha enfocado su trabajo en la investigación, el diseño y la realización de contenido audiovisual aplicado en la sistematización de proyectos sociales. Ha sido docente en temas relacionados con semántica, comunicación y la creación de contenido audiovisual. Actualmente se encuentra adelantando estudios en sociología.",
        ...
        },
        {
            ...
            description:
                "Cineasta, escritora, guionista, conferencista, docente y diseñadora industrial de la Universidad Nacional de Colombia. Nacida en Bogotá, Colombia, se ha desempeñado en diferentes áreas artísticas, gubernamentales e institucionales. En su trayectoria se ha desempeñado como directora, guionista y productora de cortometrajes realizados en Colombia y México con más de 60 premios y reconocimientos alrededor del mundo. Sus más recientes galardones en cine han sido con el cortometraje TANIA (Colombia, 2024), ganador de cinco premios en Colombia, Inglaterra y Estados Unidos; con el cortometraje TRES NOCHES (México, 2024) con un premio en Inglaterra y tres nominaciones, y LA AUDICIÓN (México, 2023) ganador con dos premios en México y Estados Unidos. <br />Actualmente, se desempeña como CEO de La Cachaca Films, productora audiovisual dedicada a la escritura y producción de piezas audiovisuales para cine y televisión.  <br />Como escritora de cuento y novela tiene más de 20 premios a nivel internacional así como publicaciones en antologías, revistas y publicaciones en diferentes países de iberoamérica. Su reconocida novela El ladrón de Julios ha sido galardonada y publicada en México y Colombia.",
            img: "./assets/img/invitados/principales/Dayana-González.jpeg",
        },
        {
            id: 5,
        ...
        {
            id: 4,
            title: "Juan Camilo Rodríguez  (Invitado Distrital)",
            charge: "Conferencista",
            description:
