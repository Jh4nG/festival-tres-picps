    ...
    proyects: [
        {
            ...
            path: "https://aleteotransmedia.com/",
        },
        {
            id: "2",
            title: "Museo Interactivo",
            description: "Aleteo hacia el futuro",
            img: "./assets/img/invitados/proyectos/Museo.png",
            path: "https://museointeractivoaleteo.com/",
        },
        {
            id: "3",
            title: "Documental Interactivo",
            description: "Rostros y espacios",
            img: "./assets/img/invitados/proyectos/DI.webp",
            path: "https://dirostrosyespacios.com/",
        },
    ],
};
