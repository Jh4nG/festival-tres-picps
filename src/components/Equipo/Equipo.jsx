            ...
            <div className="equipo__card__container">
                <div className="equipo__card__card">
                    ...
                    <div className="equipo__card__back">
                        ...
                        <div className="equipo__card__icons">
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                width="32"
                                height="32"
                                fill="currentColor"
                                className="equipo__card__bi equipo__bi-instagram"
                                viewBox="0 0 16 16"
                            >
                            ...
                            <svg
                                ...
                                height="32"
                                fill="currentColor"
                                className="equipo__card__bi equipo__bi-twitter-x"
                                viewBox="0 0 16 16"
                            >
                            ...
                            <svg
                                ...
                                height="32"
                                fill="currentColor"
                                className="equipo__card__bi equipo__bi-whatsapp"
                                viewBox="0 0 16 16"
                            >
                            ...
                            <svg
                                ...
                                height="32"
                                fill="currentColor"
                                className="equipo__card__bi equipo__bi-facebook"
                                viewBox="0 0 16 16"
                            >
